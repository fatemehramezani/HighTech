<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/UserMasterPage.master" AutoEventWireup="true" CodeFile="Product.aspx.cs" Inherits="Administrator_Product" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="DescriptionContent" runat="Server">
    مدیر سایت محترم از طریق این صفحه می توانید اطلاعات محصولات و طرح های ثبت شده متقاضیات را برای نمایش مدیریت نمایید.
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:MultiView runat="server" ID="ProductMultiView" ActiveViewIndex="0">
        <asp:View runat="server" ID="ShowView">
            ...
            <asp:GridView ID="ProductGridView" runat="server" AllowPaging="True" AllowSorting="True"
                DataKeyNames="Id" DataSourceID="ProductEntityDataSource"
                Width="90%" AutoGenerateColumns="False" OnSelectedIndexChanged="ProductGridView_SelectedIndexChanged" PageSize="5">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
        ...
        <asp:View runat="server" ID="EditView">
            <asp:FormView ID="ProductFormView"  Width="90%" runat="server" DataSourceID="ProductEntityDataSource" DataKeyNames="Id" DefaultMode="Insert"
                ...
                <EditItemTemplate>
                    ...
                    <asp:CheckBox ID="IsValidCheckBox" runat="server" Text="تایید شده" Checked='<%# Bind("IsValid") %>' />
                    <br />
                    <asp:Label ID="NameLabel" runat="server" Text="نام:" SkinID="Caption" CssClass="lable"></asp:Label>
    ...
    <asp:HiddenField runat="server"  ID="ApplicantHiddenField" />
    <asp:EntityDataSource ID="ProductEntityDataSource" runat="server" ConnectionString="name=DatabaseEntities"
        ...
        Where="it.IsRequested = False and (@Name is null || it.Name LIKE '%' + @Name + '%') And (@Description is null || it.Description LIKE '%' + @Description + '%')">
        <WhereParameters>
