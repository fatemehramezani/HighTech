<%@ Page Title="مدیریت کاربران" Language="C#" MasterPageFile="~/App_MasterPage/UserMasterPage.master"
...
<asp:Content ID="UserContent" ContentPlaceHolderID="MainContent" runat="Server">
    <asp:MultiView runat="server" ID="UserMultiView" ActiveViewIndex="0">
        <asp:View runat="server" ID="ShowView">
            ...
            <asp:Label ID="DescriptionLabel" runat="server" Text="نام خانوادگی:" SkinID="Caption" CssClass="lable"></asp:Label>
            <asp:TextBox ID="LastNameTextBox" runat="server"></asp:TextBox>
            <br />
            <asp:Label ID="UserNameLabel" runat="server" Text="نام کاربری:" SkinID="Caption" CssClass="lable"></asp:Label>
        ...
        <asp:View runat="server" ID="EditView">
            <asp:FormView SkinID="PanelFormView" ID="UserFormView" runat="server" DataSourceID="UserEntityDataSource"
                ...
                <InsertItemTemplate>
                    ...
                    <div class="rows">
                        <asp:Button ID="InsertButton" runat="server" SkinID="MetroInsertModeButton" CommandName="Insert" Text="ایجاد"
                            ValidationGroup="Insert" />
                        <asp:Button ID="CancelButton" runat="server" SkinID="MetroInsertModeButton" CausesValidation="False" CommandName="Cancel"
                            Text="انصراف" />
                    </div>
                </InsertItemTemplate>
            </asp:FormView>
