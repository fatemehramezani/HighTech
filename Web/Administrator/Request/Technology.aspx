<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/UserMasterPage.master" AutoEventWireup="true" CodeFile="Technology.aspx.cs" Inherits="Administrator_Technology" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:EntityDataSource ID="TechnologyEntityDataSource" runat="server" ConnectionString="name=DatabaseEntities" DefaultContainerName="DatabaseEntities"
        ...
        Where="it.IsRequested = True And (@PersianName is null || it.PersianName LIKE '%' + @PersianName + '%') And (@EnglishName is null || it.EnglishName LIKE '%' + @EnglishName + '%')">
        <WhereParameters>
