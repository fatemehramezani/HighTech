<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/UserMasterPage.master" AutoEventWireup="true" CodeFile="Product.aspx.cs" Inherits="Administrator_Request_Product" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="DescriptionContent" runat="Server">
    مدیر سایت محترم از طریق این صفحه می توانید اطلاعات محصولات و طرح های درخواست شده متقاضیان را مدیریت نمایید.
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:MultiView runat="server" ID="ProductMultiView" ActiveViewIndex="0">
        <asp:View runat="server" ID="ShowView">
            ...
            <asp:GridView ID="ProductGridView" runat="server" AllowPaging="True" AllowSorting="True"
                ...
                Width="90%" AutoGenerateColumns="False" OnSelectedIndexChanged="ProductGridView_SelectedIndexChanged">
                <Columns>
                    <asp:TemplateField>
                        <ItemTemplate>
    ...
    <asp:EntityDataSource ID="ProductEntityDataSource" runat="server" ConnectionString="name=DatabaseEntities"
        ...
        Where="it.IsRequested = True and (@Name is null || it.Name LIKE '%' + @Name + '%') And (@Description is null || it.Description LIKE '%' + @Description + '%')">
        <WhereParameters>
