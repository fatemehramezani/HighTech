<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/UserMasterPage.master" AutoEventWireup="true" CodeFile="SpecialService.aspx.cs" Inherits="Basic_SpecialService" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table>
        <tr>
            <td>
                ...
                <br />
                <asp:Label ID="SpecialServiceNameLabel" runat="server" Text="عنوان:" SkinID="Caption" CssClass="lable"></asp:Label>
                <asp:TextBox ID="SpecialServiceNameTextBox" runat="server" SkinID="TextBox"></asp:TextBox>
        ...
        <tr>
            <td>
                <div style="float: right; width: 300px; vertical-align: top;" dir="rtl" class="gvclass">
                    <asp:GridView ID="SpecialServiceGridView" runat="server" AllowPaging="True" AllowSorting="True"
                        DataKeyNames="Id" DataSourceID="SpecialServiceEntityDataSource"
                        Width="100%" AutoGenerateColumns="False" OnSelectedIndexChanged="SpecialServiceGridView_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                ...
                <div dir="rtl" style="padding-right: 20px; width: 300px; vertical-align: top; float: left;">
                    <asp:FormView ID="SpecialServiceFormView" runat="server" DataSourceID="SpecialServiceEntityDataSource" DataKeyNames="Id" DefaultMode="Insert">
                        <EditItemTemplate>
                            <div style="margin: 10px;">
                                <asp:Label ID="SpecialServiceNameLabel" runat="server" Text="عنوان:" SkinID="Caption" CssClass="lable"></asp:Label>
                                <asp:TextBox ID="SpecialServiceNameTextBox" runat="server" Text='<%# Bind("Name") %>' />
                                <asp:RequiredFieldValidator ID="SpecialServiceNameRequiredSpecialServiceValidator" runat="server" ControlToValidate="SpecialServiceNameTextBox"
    ...
    <asp:EntityDataSource ID="SpecialServiceEntityDataSource" runat="server" ConnectionString="name=DatabaseEntities" DefaultContainerName="DatabaseEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="SpecialServices" OnDeleted="SpecialServiceEntityDataSource_Command"
        OnInserted="SpecialServiceEntityDataSource_Command" OnUpdated="SpecialServiceEntityDataSource_Command"
        Where="(@Name is null || it.Name LIKE '%' + @Name + '%')" AutoGenerateOrderByClause="True">
        <WhereParameters>
            <asp:ControlParameter ControlID="SpecialServiceNameTextBox" Name="Name" Type="String" />
        </WhereParameters>
        <OrderByParameters>
            <asp:ControlParameter ControlID="SpecialServiceGridView" Name="OrderBy" PropertyName="SortExpression"
                Type="String" />
        </OrderByParameters>
