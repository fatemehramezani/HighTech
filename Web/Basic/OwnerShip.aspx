<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/UserMasterPage.master" AutoEventWireup="true" CodeFile="OwnerShip.aspx.cs" Inherits="Basic_OwnerShip" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table>
        <tr>
            <td>
                ...
                <br />
                <asp:Label ID="OwnerShipNameLabel" runat="server" Text="عنوان:" SkinID="Caption" CssClass="lable"></asp:Label>
                <asp:TextBox ID="OwnerShipNameTextBox" runat="server" SkinID="TextBox"></asp:TextBox>
        ...
        <tr>
            <td>
                <div style="float: right; width: 300px; vertical-align: top;" dir="rtl" class="gvclass">
                    <asp:GridView ID="OwnerShipGridView" runat="server" AllowPaging="True" AllowSorting="True"
                        DataKeyNames="Id" DataSourceID="OwnerShipEntityDataSource"
                        Width="100%" AutoGenerateColumns="False" OnSelectedIndexChanged="OwnerShipGridView_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                ...
                <div dir="rtl" style="padding-right: 20px; width: 300px; vertical-align: top; float: left;">
                    <asp:FormView ID="OwnerShipFormView" runat="server" DataSourceID="OwnerShipEntityDataSource" DataKeyNames="Id" DefaultMode="Insert">
                        <EditItemTemplate>
                            <div style="margin: 10px;">
                                <asp:Label ID="OwnerShipNameLabel" runat="server" Text="عنوان:" SkinID="Caption" CssClass="lable"></asp:Label>
                                <asp:TextBox ID="OwnerShipNameTextBox" runat="server" Text='<%# Bind("Name") %>' />
                                <asp:RequiredFieldValidator ID="OwnerShipNameRequiredOwnerShipValidator" runat="server" ControlToValidate="OwnerShipNameTextBox"
    ...
    <asp:EntityDataSource ID="OwnerShipEntityDataSource" runat="server" ConnectionString="name=DatabaseEntities" DefaultContainerName="DatabaseEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="OwnerShips" OnDeleted="OwnerShipEntityDataSource_Command"
        OnInserted="OwnerShipEntityDataSource_Command" OnUpdated="OwnerShipEntityDataSource_Command"
        Where="(@Name is null || it.Name LIKE '%' + @Name + '%')" AutoGenerateOrderByClause="True">
        <WhereParameters>
            <asp:ControlParameter ControlID="OwnerShipNameTextBox" Name="Name" Type="String" />
        </WhereParameters>
        <OrderByParameters>
            <asp:ControlParameter ControlID="OwnerShipGridView" Name="OrderBy" PropertyName="SortExpression"
                Type="String" />
        </OrderByParameters>
