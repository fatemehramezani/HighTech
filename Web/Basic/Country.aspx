<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/UserMasterPage.master" AutoEventWireup="true" CodeFile="Country.aspx.cs" Inherits="Basic_Country" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <table>
        <tr>
            <td>
                ...
                <br />
                <asp:Label ID="CountryNameLabel" runat="server" Text="عنوان:" SkinID="Caption" CssClass="lable"></asp:Label>
                <asp:TextBox ID="CountryNameTextBox" runat="server" SkinID="TextBox"></asp:TextBox>
        ...
        <tr>
            <td>
                <div style="float: right; width: 300px; vertical-align: top;" dir="rtl" class="gvclass">
                    <asp:GridView ID="CountryGridView" runat="server" AllowPaging="True" AllowSorting="True"
                        DataKeyNames="Id" DataSourceID="CountryEntityDataSource"
                        Width="100%" AutoGenerateColumns="False" OnSelectedIndexChanged="CountryGridView_SelectedIndexChanged">
                        <Columns>
                            <asp:TemplateField>
                                <ItemTemplate>
                ...
                <div dir="rtl" style="padding-right: 20px; width: 300px; vertical-align: top; float: left;">
                    <asp:FormView ID="CountryFormView" runat="server" DataSourceID="CountryEntityDataSource" DataKeyNames="Id" DefaultMode="Insert">
                        <EditItemTemplate>
                            <div style="margin: 10px;">
                                <asp:Label ID="CountryNameLabel" runat="server" Text="عنوان:" SkinID="Caption" CssClass="lable"></asp:Label>
                                <asp:TextBox ID="CountryNameTextBox" runat="server" Text='<%# Bind("Name") %>' />
                                <asp:RequiredFieldValidator ID="CountryNameRequiredCountryValidator" runat="server" ControlToValidate="CountryNameTextBox"
    ...
    <asp:EntityDataSource ID="CountryEntityDataSource" runat="server" ConnectionString="name=DatabaseEntities" DefaultContainerName="DatabaseEntities" EnableDelete="True" EnableFlattening="False" EnableInsert="True" EnableUpdate="True" EntitySetName="Countries" OnDeleted="CountryEntityDataSource_Command"
        OnInserted="CountryEntityDataSource_Command" OnUpdated="CountryEntityDataSource_Command"
        Where="(@Name is null || it.Name LIKE '%' + @Name + '%')" AutoGenerateOrderByClause="True">
        <WhereParameters>
            <asp:ControlParameter ControlID="CountryNameTextBox" Name="Name" Type="String" />
        </WhereParameters>
        <OrderByParameters>
            <asp:ControlParameter ControlID="CountryGridView" Name="OrderBy" PropertyName="SortExpression"
                Type="String" />
        </OrderByParameters>
