<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/UserMasterPage.master" AutoEventWireup="true" CodeFile="Product.aspx.cs" Inherits="Applicant_Request_Product" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="Server">
    ...
    <asp:EntityDataSource ID="ProductEntityDataSource" runat="server" ConnectionString="name=DatabaseEntities"
        ...
        Where="it.IsRequested = True and (it.ApplicantId = @ApplicantId ) And (@Name is null || it.Name LIKE '%' + @Name + '%') And (@Description is null || it.Description LIKE '%' + @Description + '%')">
        <WhereParameters>
