<%@ Page Title="" Language="C#" MasterPageFile="~/App_MasterPage/UserMasterPage.master" AutoEventWireup="true" CodeFile="WebSite.aspx.cs" Inherits="Applicant_Request_WebSite" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="DescriptionContent" Runat="Server">
    متقاضی گرامی از طریق این صفحه می توانید در خواست طراحی سایت و معرفی اجمالی شرکت خود را داشته باشید.
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <div id="inline1" style="width:200px;display: none;text-align: center;">
     ...
     <div id="Div1" style="width:200px;display: none;text-align: center;">
		<h2>ارسال درخواست </h2>
        <hr/>
		<h3>
